...
const vrLink = ref('https://my.matterport.com/show/?m=AiedZirEMdG')

const changeStyle = () => {
    // alert('test')
    var iframe = document.getElementById("capture3d");
    var elmnt = iframe.contentWindow.document.getElementsByClassName("_37lI0GF_v0RS5bCmm8IPC9");
    console.log(elmnt)
    // _37lI0GF_v0RS5bCmm8IPC9
    // elmnt.innerHTML = "Furniture";
}
</script>
...
<!-- <section class="h-screen flex items-center justify-center">
    <video autoplay muted loop src="ui.mp4" class="absolute w-full -z-10"></video>
    <div class="w-1/2 text-center text-white">
        <h1 class="text-5xl">Universitas Indonesia</h1>
        <p class="text-lg mt-5">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Illo cumque nesciunt voluptatibus? Lorem, ipsum.</p>
        <button class="py-2 px-6 rounded-full border mt-10">Explore More</button>
    </div>
</section> -->
<!-- FULL VIDEO-END -->
...
<!-- <div class="grid md:grid-cols-2 md:grid-rows-1 md:h-screen h-[140vh] gap-2 grid-rows-2">
    <nav id="nav" class="absolute right-0 left-0 top-0 h-14 flex items-center md:justify-between px-10 justify-between text-black"> 
        ...
        <div class="text-sm  md:flex hidden font-semibold ml-[10%]">
            <a href="#" class="mx-5 hover:underline underline-offset-8 decoration-2 hover:text-[#4f43e5]">VR-Lab</a>
            <a href="#" class="mx-5 hover:underline underline-offset-8 decoration-2 hover:text-[#4f43e5]">制作フロー</a>
            <a href="#" class="mx-5 hover:underline underline-offset-8 decoration-2 hover:text-[#4f43e5]">料金</a>
            <a href="#" class="mx-5 hover:underline underline-offset-8 decoration-2 hover:text-[#4f43e5]">会社案内</a>
        </div> 
...
<div class="container relative mx-auto bg-white">
    
    <div class="absolute top-4 right-4 flex flex-col md:p-20 py-5">
        <span>
            <!-- <button class="bg-teal-500  rounded-md py-[10px] px-[14px]  border border-slate-400 text-white font-semibold me-4">Beranda</button> -->
            
            <button type="button" class="text-white bg-gradient-to-r from-red-400 via-red-500 to-red-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2 rounded-full" @click="vrLink = 'https://my.matterport.com/show/?m=AiedZirEMdG'">Original</button>
            
            <button type="button" class="text-white bg-gradient-to-r from-red-400 via-red-500 to-red-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2 rounded-full" @click="vrLink = 'https://app.upstager.co/KBE5XYy0VrpnvU7iUfnY?d=mTnMWGHFb6lBKoOXFZ4k'">Furnitur</button>
            
            <button type="button" class="text-white bg-gradient-to-r from-red-400 via-red-500 to-red-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2 rounded-full">Tutup</button>
            <!-- <button class="bg-teal-500  rounded-md py-[10px] px-[14px]  border border-slate-400 text-white font-semibold">VR Tour</button> -->
        </span>
    </div>

    <div class="flex flex-col md:p-20 py-5">
        <iframe width='100%' height='780' :src='vrLink' frameborder='0' allowfullscreen allow='xr-spatial-tracking' style="margin: 0 auto;"></iframe>
    </div>
</div>
...
<div class="container relative mx-auto bg-white">
    ...
    <div class="flex flex-col md:p-20 py-5">
        <!-- Versi upstager -->
        <iframe src="https://app.upstager.co/KBE5XYy0VrpnvU7iUfnY?d=mTnMWGHFb6lBKoOXFZ4k" width="100%" height="780" style="margin: 0 auto;"/>

        <!-- Versi Capture3d -->
          <iframe id="capture3d" class="captur3d-3d-tour__iframe"
            width="920"
            height="540"
            src="https://captur3d.io/view/pt-rupa-raya-indonesia/jl-a-p-pettarani-2-tamamaung-kec-panakkukang-kota-makassar-sulawesi-selatan-90231-indonesia"
            frameborder="0"
            allowfullscreen=""
          ...
          <button class="text-white bg-gradient-to-r from-red-400 via-red-500 to-red-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2 rounded-full" @click="changeStyle()">Test</button>

        <!-- <iframe width='100%' height='780' src='https://my.matterport.com/show/?m=AiedZirEMdG' frameborder='0' allowfullscreen allow='xr-spatial-tracking' style="margin: 0 auto;"></iframe> -->
    </div>
</div>
<!-- VR STAGING-END -->
